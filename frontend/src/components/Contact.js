      ...
      <div className="container">
        <div className="section-header">
          ...
          <p className="section-subtitle">
            Ready to start your chess journey? Let's connect through any of these channels
          </p>
        </div>
        ...
        <div className="contact-info-only">
          <div className="contact-info-center">
            ...
            <p className="contact-info-description">
              ...
              I'm here to help you achieve your chess goals. Reach out through any of the 
              channels below to discuss personalized training programs.
            </p>
